...
>
        ...
        %>
                        <center><h3 style="color: black"><b>Data Owner Login</b></h3>
                            ...
                            <form action="DO_login.jsp" method="get" >
                                ...
                                <div class="form-group" style="width: 400px" >
                                    <input type="text" name="email" required="" class="form-control p_input"autocomplete="off" >
                                </div>
                                <br>
                                <br>
                        ...
                        <div>
                            <center><button onclick="openForm()" class="btn btn-primary btn-block enter-btn" style="width: 200px ; background-image: linear-gradient(135deg, #667eea 0%, #764ba2 100%);"><a>Registration</a></button></center>
                            <br><br>
                        </div>
                        <div class="form-popup" id="myForm">
                            <form action="DO_signup.jsp" method="get" class="form-container">
                                ...
                                <select name="group" required>
                                    <option value="Group01123456789">Group 1</option>
                                    <option value="Group02123456789">Group 2</option>
                                    <option value="Group03123456789">Group 3</option>
                                </select>
