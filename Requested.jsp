<%-- 
    Document   : DO_Home
    Created on : Nov 13, 2019, 6:57:22 PM
    Author     : java1
--%>
...
<html lang="en">
    ...
    <%
        ...
        <script>alert('Invalid Key OR Key Time Expired');</script>  
        <%}
        %>
                    ...
                    <nav class="sidebar sidebar-offcanvas" id="sidebar"style="background: white">                        
                        <ul class="nav">
                            <li class="nav-item active">
                                <a class="nav-link" href="Member_Home.jsp">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="Search.jsp">
                                    ...
                                    <span class="menu-title"><b style="color: #33D4FF">Search Files</b></span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="Requested.jsp">
                                    <img src="images/arrow.png" width="200px" alt="">
                                    <span class="menu-title"><b style="color: #33D4FF">Requested Files</b></span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="Download.jsp">
                                    <img src="images/arrow.png" width="200px" alt="">
                                    <span class="menu-title"><b style="color: #33D4FF">Download History</b></span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="index.jsp">
                                    <img src="images/arrow.png" width="200px" alt="">
                                    <span class="menu-title"><b style="color: #33D4FF">Logout</b></span>
                                </a>
                            </li>
                        </ul>
                    </nav>
                            ...
                            <table id="customers">
                                           <thead>
                                            ...
                                            <%
                                                ...
                                                try {
                                                    ResultSet rs = st.executeQuery("Select * from request where mid ='" +mid+ "'");
                                                    while (rs.next()) {
                                            %>
                                            <tbody>
                                                <tr class="odd gradeX">
                                                    ...
                                                    <td class="center"><%=rs.getString("statuss")%> </td>
                                                    <td><i><a href="view_data.jsp?fid=<%=rs.getString("fid")%>&fname=<%=rs.getString("filename")%>"  style="color: green ; width: 40px; height: 40px">Decrypt Data</a></i></td>
                                                </tr>
                                            </tbody>
                                            <%                                        }
                                                } catch (Exception ex) {
